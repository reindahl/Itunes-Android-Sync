			...
			try {
				if(progress!=0){
					...
					if(elapsedTimeSeconds>0 ){
						...
						System.out.println("size left: "+helperFiles.Conversion.byteToString(size-progress, false));
						...
						if(((long)elapsedTimeSeconds)>0){
							...
							System.out.println("transfer Rate: "+helperFiles.Conversion.byteToString(transferRate, false)+"/s");
							gui.updateInfo(helperFiles.Conversion.byteToString(transferRate, false),helperFiles.Conversion.secondsToHMS(estimate),helperFiles.Conversion.byteToString(size-progress, false));
						}
